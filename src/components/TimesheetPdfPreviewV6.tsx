...
import TimesheetPdfDocumentV6 from "./TimesheetPdfDocumentV6";
...
const TimesheetPdfPreviewV6 = ({ employee, month, year, dailyRecords, logoSrc }: TimesheetPdfPreviewV6Props) => {
  ...
  const handleDownloadPdfDirect = async () => {
    ...
    try {
      ...
      const filename = `Folha_de_Ponto_V6_${employee.name.replace(/\s/g, '_')}_${month}_${year}.pdf`;
...
export default TimesheetPdfPreviewV6;