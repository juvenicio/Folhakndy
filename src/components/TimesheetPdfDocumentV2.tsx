        ...
        <View style={styles.tableRow}>
          ...
          <View style={[styles.infoCellBase, { width: '40%', borderRightWidth: 0 }]}>
            <Text style={{ fontFamily: 'Arial', fontSize: 10 }}>
              Gestor(a) ({getRoleMark(employee.employee_type, "Gestor")}) Técnico ({getRoleMark(employee.employee_type, "Técnico")}) Professor(a) ({getRoleMark(employee.employee_type, "Professora")})
            </Text>
          </View>
        </View>
        <View style={styles.tableRow}>
