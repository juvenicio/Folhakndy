...
const employeeFormSchema = z.object({
  ...
  employee_type: z.enum(["ASG", "Merendeira", "Vigia", "Secretário(a)", "Professor", "Assistente Social", "Psicólogo(a)", "Gestor(a)", "Educador Voluntário", "Professor Fundamental II", "Supervisor(a)"], {
  ...
  ), // Novo campo, agora explicitamente não obrigatório
...
const EmployeeForm = ({ employee, onSuccess }: EmployeeFormProps) => {
  const form = useForm<EmployeeFormValues>({
    ...
    defaultValues: {
      ...
      discipline: employee?.discipline || null, // Default para null
      weekly_hours: employee?.weekly_hours || null, // Default para null
