...
const Sidebar = ({ isCollapsed, setIsCollapsed }: SidebarProps) => {
  ...
  return (
    <div
      className={cn(
        "flex h-full flex-col gap-4 border-r bg-sidebar-background",
        // Desktop styles
        !isMobile && (isCollapsed ? "w-16" : "w-64"),
        // Mobile styles: always fixed, control visibility with transform
        isMobile && "fixed inset-y-0 left-0 z-50 w-3/4 max-w-xs shadow-lg transform transition-transform duration-300 ease-in-out",
