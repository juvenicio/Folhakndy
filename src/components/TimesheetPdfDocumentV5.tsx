    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.mainTableContainer}>
        ...
        <View style={styles.tableRow}>
          <View style={[styles.infoCellBase, { width: '100%', borderTopWidth: 0, borderLeftWidth: 0, borderRightWidth: 0 }]}>
        ...
        <View style={styles.tableRow}>
          <View style={[styles.infoCellBase, { width: '66.66%', borderLeftWidth: 0, borderBottomWidth: 0 }]}>
          ...
          <View style={[styles.infoCellBase, { width: '16.67%', borderBottomWidth: 0 }]}>
            <Text style={{ fontFamily: 'Calibri', fontSize: 9 }}>Mês: {monthNameFormatted}</Text>
          </View>
          <View style={[styles.infoCellBase, { width: '16.67%', borderRightWidth: 0, borderBottomWidth: 0 }]}>
            <Text style={{ fontFamily: 'Calibri', fontSize: 9 }}>Ano: {year}</Text>
          </View>
        </View>
        ...
        <View style={styles.tableRow} fixed>
          ...
          <View style={[styles.tableHeaderCell, styles.colAula, { borderTopWidth: 1.5 }]}>
          ...
          <View style={[styles.tableHeaderCell, styles.colAulaLast, { borderRightWidth: 0, borderTopWidth: 1.5 }]}>
        ...
        {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day, index) => {
          ...
          return (
            <View style={styles.tableRow} key={day}>
              ...
              <Text style={[styles.infoCellBase, styles.colAula, { fontFamily: 'Calibri', fontSize: 8 }, displayNotes !== '' && styles.boldText, { borderBottomWidth: isLastDailyRecordRow ? 0 : 1.5 }]}>{displayNotes}</Text>
              <Text style={[styles.infoCellBase, styles.colAula, { fontFamily: 'Calibri', fontSize: 8 }, displayNotes !== '' && styles.boldText, { borderBottomWidth: isLastDailyRecordRow ? 0 : 1.5 }]}>{displayNotes}</Text>
              <Text style={[styles.infoCellBase, styles.colAula, { fontFamily: 'Calibri', fontSize: 8 }, displayNotes !== '' && styles.boldText, { borderBottomWidth: isLastDailyRecordRow ? 0 : 1.5 }]}>{displayNotes}</Text>
              <Text style={[styles.infoCellBase, styles.colAula, { fontFamily: 'Calibri', fontSize: 8 }, displayNotes !== '' && styles.boldText, { borderBottomWidth: isLastDailyRecordRow ? 0 : 1.5 }]}>{displayNotes}</Text>
              <Text style={[styles.infoCellBase, styles.colAula, { fontFamily: 'Calibri', fontSize: 8 }, displayNotes !== '' && styles.boldText, { borderBottomWidth: isLastDailyRecordRow ? 0 : 1.5 }]}>{displayNotes}</Text>
              <Text style={[styles.infoCellBase, styles.colAulaLast, { fontFamily: 'Calibri', fontSize: 8 }, displayNotes !== '' && styles.boldText, { borderRightWidth: 0, borderBottomWidth: isLastDailyRecordRow ? 0 : 1.5 }]}>{displayNotes}</Text>
            </View>
          );
        })}
        ...
        <View style={styles.tableRow}>
          <View style={[styles.infoCellBase, { width: '100%', borderLeftWidth: 0, minHeight: 15, borderRightWidth: 0 }]}>
            <Text></Text>
          </View>
        </View>
        <View style={styles.tableRow}>
          <View style={[styles.infoCellBase, { width: '100%', borderLeftWidth: 0, borderRightWidth: 0, minHeight: 15 }]}>
            <Text></Text>
          </View>
        </View>
        <View style={styles.tableRow}>
